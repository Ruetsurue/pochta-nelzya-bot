class MessageTexts:
    START_MSG = "Почта, нельзя!!!!\n\n" \
                "Кто бля и когда бля последний раз кормил и выгуливал эту псину?\n\n" \
                "Как за всем уследить, если ты несчастный независимый журналист, неспособный вылезти из валоранта, " \
                "а она неудержимая армянская псина, что в одно рыло сожрет половину мусора Армении и не подавится?\n\n"\
